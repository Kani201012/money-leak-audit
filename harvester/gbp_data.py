def normalize_gbp_data(raw_lead):
    ...
    Ensures 'website' and 'photos' are passed correctly to the Report Generator.
    """
    
    # 1. Clean Website Logic
    # We want the actual URL string, not just True/False
    ...
    return {
        ...
        # CRITICAL FIX: Pass the URL string explicitly
        "website": website_url,
        ...
        "reviews": reviews,
        "photos": photos,
        "photos_count": photos, # Redundant backup for safety
